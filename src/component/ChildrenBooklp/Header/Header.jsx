            ...
            <div className="items-center justify-between gap-x-4 flex grid-cols-2 grid-rows-1">
              <div className="flex-shrink-0">
                <Link href="/" className="text-xl font-bold text-indigo-500">
                  <Image quality={95} src={Logo} alt=" Broadway Publishers Ghostwriting logo" width={180} height={50} priority={true} />
                </Link>
              </div>
              <nav className="flex w-full justify-end mr-xl:gap-x-[110px] mr-2xl:gap-x-[180px] space-x-4 text-[16px] text-[#1d1d1f] font-medium">
                ...
                <ul className='btn'>
                  <li className='mr-lg:!mb-0 !mb-3 block sm:hidden xs:hidden'>
                    <Link href="tel:855-666-6675" className={`__animatedPing text-[15px] transition-all ease-in-out duration-300 group xs:text-[20px] font-secondary border-2 border-black bg-[#3EA99F] py-2 px-4 text-[#3EA99F] flex items-center gap-x-3 font-[500] hover:bg-transparent rounded-[6px] hover:border-2 hover:border-white`}>
