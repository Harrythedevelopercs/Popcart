                            ...
                            <nav className="flex w-full justify-end mr-xl:gap-x-[110px] mr-2xl:gap-x-[210px] space-x-4 text-[16px] text-[#1d1d1f] font-medium">
                                ...
                                <ul className='btn'>
                                    <li className='mr-lg:!mb-0 !mb-3 block sm:hidden xs:hidden'>
                                        <Link href="tel:855-666-6675" className={`__animatedPing text-[15px] transition-all ease-in-out duration-300 group xs:text-[20px] ppmori border-2 border-[#3EA99F] bg-[#3EA99F] py-2 px-4 text-[#3EA99F] flex items-center gap-x-3 font-[500] hover:bg-transparent rounded-[50px] hover:border-2 hover:border-white`}>
