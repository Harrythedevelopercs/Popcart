                    ...
                    <div className="mr-container">
                        ...
                        <ul className="list-disc list-inside my-5">
                            {
                                [
                                    ...
                                    ["“Organization”, “we”, “us”, and “our” refer to the Broadway Publishers."],
                                    ["“Unrelated Entities” means third parties that are not Educational Partners and who are not providing services to Broadway Publishers. as Business Associates."],
                        ...
                        <ul className="list-disc list-inside mb-5">
                            ...
                            <li className="text-[16px] leading-[28px] text-[#212121] font-normal">
                                <span> E-mail: <a href="mailto:info@broadwaypublishers.com" className="font-medium text-primary-100">info@broadwaypublishers.com</a></span>
                            </li>
                        </ul>
                    </div>
                </div>
