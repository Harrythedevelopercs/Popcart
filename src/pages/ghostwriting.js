...
const ProfessionalGhostwriting = () => {
  ...
  const schemaWebsite = {
    ...
    "@type": "WebSite",
    name: "Ghostwriting Services | Broadway Publishers",
    url: "https://www.broadwaypublishers.com/ghostwriting",
    potentialAction: {
      "@type": "SearchAction",
  ...
  return (
    <main>
      <Head>
        ...
        <title>
          Professional Ghostwriting Services | Broadway Publishers
        </title>
        <meta
          name="description"
          content="Broadway Publishers offers professional ghostwriting services tailored to your needs. Start your publishing journey today and see why we're the premier choice for authors."
        />

        <meta
          property="og:url"
          content="https://www.broadwaypublishers.com/ghostwriting"
        />
        <meta
          property="og:image"
        ...
        <link
          rel="canonical"
          href="https://www.broadwaypublishers.com/ghostwriting"
        />
